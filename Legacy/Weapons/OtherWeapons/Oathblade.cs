...
namespace Legacy.Weapons
{
    public class Oathblade : Weapon, IPostSpecial
    {
        public Oathblade() 
        {
            ...
            Special = "После убийства противника СЛУЧАЙНО определится одно из следующих событий: 1)Герой получит [+5] к максимальному здоровью 2) Вы будете ранены на [5] урона";
